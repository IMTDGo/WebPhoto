...
const I18N_SYSTEM = (() => {
  ...
  const I18N = {
    en: {
      ...
      beta_priv2_desc: 'All uploaded files and generated texture sets are automatically deleted from our servers 48 hours after the project is created. Do not rely on SNAPBRIFY as a permanent storage solution.',
      ...
      beta_lim2_val: '48 hours',
      beta_lim2_desc: 'All projects and generated files are permanently deleted 48 hours after creation.',
      ...
      // index.html — long-scroll landing sections
      home_canvas_hint: 'Move cursor to explore',
      home_about_eyebrow: 'What is Snapbrify',
      home_about_title_html: 'From a Photograph<br/>to a Production&#8209;Ready Material',
      home_about_body1: 'SNAPBRIFY turns any surface you can photograph — wood, stone, fabric, leather, concrete — into a complete, seamless PBR texture set, ready for game engines and 3D software.',
      home_about_body2: 'Everything happens directly in your browser. Capture with your phone, refine the crop, and the engine computes every channel map on your device — then delivers the finished set as a ZIP or straight to your inbox.',
      home_stat_channels: 'Channel Maps',
      home_stat_res: 'Max Output',
      home_stat_retention: 'Privacy Auto-Clean',
      home_stat_browser: 'In-Browser Processing',
      home_how_eyebrow: 'The Process',
      home_how_title: 'Four Steps to a Finished Material',
      home_step1_title: 'Capture',
      home_step1_desc: 'Shoot a surface with your phone or import from your gallery. HDR merge and auto white-balance keep colour faithful to reality.',
      home_step2_title: 'Refine',
      home_step2_desc: 'Frame the perfect crop, then let the seamless-tiling engine erase visible repeats so the texture wraps endlessly.',
      home_step3_title: 'Generate',
      home_step3_desc: 'The full PBR channel set is computed right on your device — Base Color, Roughness, Ambient Occlusion, Height and Normal.',
      home_step4_title: 'Deploy',
      home_step4_desc: 'Download the whole set as a ZIP, have it mailed to your inbox, and revisit any material in your project history.',
      home_channels_eyebrow: 'The Output',
      home_channels_title: 'One Photo. A Complete Material.',
      home_channels_desc: 'Hover each channel to preview how a single capture becomes every map your renderer needs.',
      home_ch_basecolor: 'Base Color',
      home_ch_basecolor_desc: 'The true albedo of the surface, light-neutralised',
      home_ch_roughness: 'Roughness',
      home_ch_roughness_desc: 'How sharply or softly the surface scatters light',
      home_ch_ao: 'Ambient Occlusion',
      home_ch_ao_desc: 'Soft contact shadows nestled in every crevice',
      home_ch_height: 'Height',
      home_ch_height_desc: 'Displacement data for true surface relief',
      home_ch_metallic: 'Metallic',
      home_ch_metallic_desc: 'Conductor vs. dielectric response, per pixel',
      home_ch_normal: 'Normal',
      home_ch_normal_desc: 'Micro-detail lighting without extra geometry',
      home_why_eyebrow: 'Crafted for Creators',
      home_why_title: 'Everything Considered',
      home_f1_title: 'Seamless by Default',
      home_f1_desc: 'Edge-blending erases visible seams, so every texture tiles infinitely across any UV layout.',
      home_f2_title: 'HDR & White Balance',
      home_f2_desc: 'Multi-exposure merge and automatic white balance recover detail that single shots lose.',
      home_f3_title: 'Zero Installation',
      home_f3_desc: 'Runs entirely in the browser on Web Workers — your laptop and your phone are the whole pipeline.',
      home_f4_title: 'Delivered to Your Inbox',
      home_f4_desc: 'Finish on your phone, open on your workstation — every set can be mailed to you with a 48-hour ZIP link.',
      home_f5_title: 'Project History',
      home_f5_desc: 'Every upload is archived to your account — re-download channels or the full ZIP any time within the retention window.',
      home_f6_title: 'Private by Design',
      home_f6_desc: 'Generated files auto-delete from the cloud after 48 hours. Your source photos never leave your device.',
      home_cta_eyebrow: 'Free While in Beta',
      home_cta_title: 'Begin Your Material Library',
      home_cta_desc: 'Three material sets a day, six channel maps each — all it takes is a photograph.',
      home_footer_tagline: 'Photograph reality. Generate seamless PBR materials in your browser. Deploy anywhere.',
      home_footer_explore: 'Explore',
      home_footer_connect: 'Connect',
      // auth pages (login/signup/reset-password redesign)
      auth_eyebrow_login: 'Member Access',
      auth_forgot_password: 'Forgot password?',
      auth_eyebrow_signup: 'Join the Studio',
      auth_eyebrow_reset: 'Account Recovery',
      auth_reset_title: 'Reset Password',
      auth_reset_desc: 'Enter your account email to receive a verification code.',
      auth_email_label: 'Email',
      auth_email_hint: 'A 6-digit code will be sent to your inbox · valid 10 min',
      auth_back_to_login: 'Back to Login',
      auth_send_code: 'Send Code',
      auth_verify_reset_title: 'Verify & Reset',
      auth_code_sent_to: 'Code sent to',
      auth_otp_label: 'Verification Code',
      auth_new_password_label: 'New Password',
      auth_new_password_hint: 'At least 8 characters, including letters and numbers',
      ...
      // info pages (contact/manage-plan redesign)
      contact_form_eyebrow: 'Correspondence',
      contact_form_title: 'Write to the Studio',
      plan_eyebrow: 'Membership',
      plan_discuss_eyebrow: 'Your Voice',
      // mobile.html editor redesign
      mobile_eyebrow: 'PBR Material Studio',
      mobile_step_capture: 'Capture',
      mobile_step_refine: 'Refine',
      mobile_step_review: 'Review',
      mobile_take_photo_sub: 'Camera with HDR & white balance',
      mobile_gallery_sub: 'JPG, PNG or TIFF from your photos',
      mobile_recent: 'Recent Materials',
      mobile_clear: 'Clear',
      mobile_wb_hint: 'Tap a white object to set white balance',
      mobile_wb_done: 'White balance applied (tap WB to reset)',
      mobile_keep_steady: 'Keep your device steady',
      mobile_cam_error: 'Cannot open built-in camera',
      mobile_cam_error_sub: 'Please use your system camera to take a photo',
      mobile_open_system_cam: 'Open System Camera',
      mobile_aspect_ratio: 'Aspect Ratio',
      mobile_uv_scale: 'UV Scale',
      mobile_tile: 'tile',
      mobile_crop_label: 'Crop',
      mobile_pan_hint: 'Drag to pan · Pinch to zoom',
      mobile_params: 'Parameters',
      mobile_seamless_toggle: 'Enable Seamless Tiling',
      mobile_blend_width: 'Blend Width',
      mobile_ch_basecolor: 'Base Color',
      mobile_ch_roughness: 'Roughness',
      mobile_ch_ao: 'AO',
      mobile_ch_height: 'Height',
      mobile_ch_normal: 'Normal',
      mobile_same_folder: 'All 6 channels will be uploaded to the same folder',
      mobile_folder_ph: 'e.g. wood_floor_01',
      mobile_email_ph: 'Enter email address',
      // desktop.html editor redesign
      editor_step_upload: 'Upload',
      editor_step_crop: 'Crop',
      editor_step_generate: 'Generate',
      editor_step_confirm: 'Confirm',
      editor_formats_hint: 'JPG · PNG · TIFF · Max 50 MB',
      editor_recent_title: 'Recent Materials',
      editor_recent_clear: 'Clear',
      editor_source_title: 'Material Source',
      editor_source_sub: 'Upload source image',
      editor_file_label: 'File',
      editor_res_label: 'Source Res',
      editor_uv_title: 'UV Tiling',
      editor_multiplier: 'Multiplier',
      editor_aspect_label: 'Aspect Ratio',
      editor_seamless_title: 'Seamless Generation',
      editor_seamless_enable: 'Enable Seamless',
      editor_blend_width: 'Blend Width',
      editor_source_tag: 'Source',
      editor_preview_tag: 'Preview',
      editor_empty_hint: 'Load an image to begin',
      editor_no_preview: 'No Preview',
    ...
    zh: {
      ...
      beta_priv2_desc: '所有上傳的檔案和生成的材質套組，將在專案建立後 48 小時內自動從伺服器刪除。請勿將 SNAPBRIFY 視為永久儲存方案。',
      ...
      beta_lim2_val: '48 小時',
      beta_lim2_desc: '所有專案及生成的檔案，將在建立後 48 小時內永久刪除。',
      ...
      beta_disclaimer: 'SNAPBRIFY 在測試期間按現狀提供。我們不保證持續可用性、生成材質的準確性，或在規定 48 小時保留窗口之外保留上傳的檔案。使用本平台即表示您認知並接受上述限制，並同意不將其用於儲存不可替代的資產。',
      ...
      // index.html — long-scroll landing sections
      home_canvas_hint: '移動游標探索材質',
      home_about_eyebrow: '關於 SNAPBRIFY',
      home_about_title_html: '從一張照片<br/>到可直接投產的材質',
      home_about_body1: 'SNAPBRIFY 能把任何拍得到的表面——木紋、石材、織物、皮革、混凝土——轉換成完整且無縫的 PBR 材質集，直接用於遊戲引擎與 3D 軟體。',
      home_about_body2: '一切都在瀏覽器中完成。用手機拍攝、調整裁切範圍，引擎就會在你的裝置上計算出所有通道貼圖，再以 ZIP 打包下載，或直接寄到你的信箱。',
      home_stat_channels: '通道貼圖',
      home_stat_res: '最大輸出解析度',
      home_stat_retention: '隱私自動清除',
      home_stat_browser: '瀏覽器端運算',
      home_how_eyebrow: '製作流程',
      home_how_title: '四個步驟，完成一組材質',
      home_step1_title: '拍攝',
      home_step1_desc: '用手機直接拍攝表面，或從相簿匯入。HDR 合成與自動白平衡讓色彩忠於真實。',
      home_step2_title: '修整',
      home_step2_desc: '框選最理想的裁切範圍，無縫拼接引擎會消除可見的重複痕跡，讓材質無限延伸。',
      home_step3_title: '生成',
      home_step3_desc: '完整的 PBR 通道組直接在你的裝置上運算完成——Base Color、Roughness、AO、Height 與 Normal。',
      home_step4_title: '交付',
      home_step4_desc: '整組材質打包成 ZIP 下載、寄送到信箱，並可隨時回到專案歷史重新取得。',
      home_channels_eyebrow: '輸出成果',
      home_channels_title: '一張照片，一組完整材質。',
      home_channels_desc: '將游標移到各通道上，預覽一次拍攝如何變成渲染器需要的每一張貼圖。',
      home_ch_basecolor: 'Base Color 基礎色',
      home_ch_basecolor_desc: '去除光照影響後，表面最真實的反照率',
      home_ch_roughness: 'Roughness 粗糙度',
      home_ch_roughness_desc: '決定表面反射光線的銳利或柔和程度',
      home_ch_ao: 'AO 環境光遮蔽',
      home_ch_ao_desc: '藏在每道縫隙裡的柔和接觸陰影',
      home_ch_height: 'Height 高度',
      home_ch_height_desc: '用於位移貼圖的真實表面起伏資料',
      home_ch_metallic: 'Metallic 金屬度',
      home_ch_metallic_desc: '逐像素區分金屬與非金屬的反射特性',
      home_ch_normal: 'Normal 法線',
      home_ch_normal_desc: '不增加幾何面數，就能呈現微觀光影細節',
      home_why_eyebrow: '為創作者而生',
      home_why_title: '每個細節都考慮周全',
      home_f1_title: '預設無縫',
      home_f1_desc: '邊緣融合演算法消除可見接縫，任何 UV 佈局都能無限平鋪。',
      home_f2_title: 'HDR 與白平衡',
      home_f2_desc: '多重曝光合成與自動白平衡，找回單張照片遺失的細節。',
      home_f3_title: '免安裝',
      home_f3_desc: '完全在瀏覽器中以 Web Worker 運算——你的手機和電腦就是完整的產線。',
      home_f4_title: '直送信箱',
      home_f4_desc: '手機上完成、工作站上打開——每組材質都能寄送給你，附 48 小時有效的 ZIP 連結。',
      home_f5_title: '專案歷史',
      home_f5_desc: '每次上傳都會記錄在你的帳號——保留期間內可隨時重新下載各通道或完整 ZIP。',
      home_f6_title: '隱私至上',
      home_f6_desc: '生成的檔案會在 48 小時後自動從雲端刪除，原始照片更是從未離開你的裝置。',
      home_cta_eyebrow: '測試期間完全免費',
      home_cta_title: '開始建立你的材質庫',
      home_cta_desc: '每天三組材質、每組六張通道貼圖——你只需要一張照片。',
      home_footer_tagline: '拍下真實世界，在瀏覽器中生成無縫 PBR 材質，部署到任何地方。',
      home_footer_explore: '探索',
      home_footer_connect: '聯繫',
      // auth pages (login/signup/reset-password redesign)
      auth_eyebrow_login: '會員專屬入口',
      auth_forgot_password: '忘記密碼？',
      auth_eyebrow_signup: '加入工作室',
      auth_eyebrow_reset: '帳號救援',
      auth_reset_title: '重設密碼',
      auth_reset_desc: '輸入帳號電子郵件以接收驗證碼。',
      auth_email_label: '電子郵件',
      auth_email_hint: '6 位數驗證碼將寄至您的信箱 · 10 分鐘內有效',
      auth_back_to_login: '返回登入',
      auth_send_code: '寄送驗證碼',
      auth_verify_reset_title: '驗證並重設',
      auth_code_sent_to: '驗證碼已寄至',
      auth_otp_label: '驗證碼',
      auth_new_password_label: '新密碼',
      auth_new_password_hint: '至少 8 個字元，須包含英文字母與數字',
      auth_confirm_password_label: '確認密碼',
      auth_no_code: '沒收到驗證碼？',
      auth_resend: '重新寄送',
      auth_back: '返回',
      auth_reset_btn: '重設密碼',
      auth_remembered: '想起密碼了嗎？',
      auth_login_link: '登入',
      // info pages (contact/manage-plan redesign)
      contact_form_eyebrow: '來信洽詢',
      contact_form_title: '致函工作室',
      plan_eyebrow: '會員方案',
      plan_discuss_eyebrow: '您的意見',
      // mobile.html editor redesign
      mobile_eyebrow: 'PBR 材質工作室',
      mobile_step_capture: '拍攝',
      mobile_step_refine: '調整',
      mobile_step_review: '確認',
      mobile_take_photo_sub: '相機拍攝，支援 HDR 與白平衡',
      mobile_gallery_sub: '從照片中選擇 JPG、PNG 或 TIFF',
      mobile_recent: '最近的材質',
      mobile_clear: '清除',
      mobile_wb_hint: '點按白色物體以設定白平衡',
      mobile_wb_done: '已套用白平衡（點 WB 可重設）',
      mobile_keep_steady: '請保持裝置穩定',
      mobile_cam_error: '無法開啟內建相機',
      mobile_cam_error_sub: '請改用系統相機拍照',
      mobile_open_system_cam: '開啟系統相機',
      mobile_aspect_ratio: '長寬比',
      mobile_uv_scale: 'UV 縮放',
      mobile_tile: '重複',
      mobile_crop_label: '裁切',
      mobile_pan_hint: '拖曳平移 · 雙指縮放',
      mobile_params: '參數',
      mobile_seamless_toggle: '啟用無縫拼接',
      mobile_blend_width: '混合寬度',
      mobile_ch_basecolor: '基礎色',
      mobile_ch_roughness: '粗糙度',
      mobile_ch_ao: '環境光遮蔽',
      mobile_ch_height: '高度',
      mobile_ch_normal: '法線',
      mobile_same_folder: '全部 6 個通道將上傳至同一資料夾',
      mobile_folder_ph: '例如 wood_floor_01',
      mobile_email_ph: '輸入電子郵件地址',
      // desktop.html editor redesign
      editor_step_upload: '上傳',
      editor_step_crop: '裁切',
      editor_step_generate: '生成',
      editor_step_confirm: '確認',
      editor_formats_hint: 'JPG · PNG · TIFF · 上限 50 MB',
      editor_recent_title: '近期材質',
      editor_recent_clear: '清除',
      editor_source_title: '材質來源',
      editor_source_sub: '上傳來源圖片',
      editor_file_label: '檔案',
      editor_res_label: '原始解析度',
      editor_uv_title: 'UV 平鋪',
      editor_multiplier: '平鋪倍數',
      editor_aspect_label: '長寬比',
      editor_seamless_title: '無縫生成',
      editor_seamless_enable: '啟用無縫',
      editor_blend_width: '混合寬度',
      editor_source_tag: '來源',
      editor_preview_tag: '預覽',
      editor_empty_hint: '載入圖片以開始',
      editor_no_preview: '尚無預覽',
